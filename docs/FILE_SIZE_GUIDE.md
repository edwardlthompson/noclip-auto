...
> **NoClip overrides:** Lua menu entries ≤ 50 lines; `Core/*` ≤ 200 lines (see `.cursor/rules/core-directives.mdc`). Prefer those over generic taxonomy when editing the plugin.
